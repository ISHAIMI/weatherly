...
class ThreeHourForecast extends StatelessWidget {
  @override
        ...
        children: [
          ...
          Consumer<WeatherProvider>(
            builder: (context, weatherProv, _) {
              ...
              // Using the filterThreeHourForecast method from the model
              var filteredWeather = HourlyWeather.filterThreeHourForecast(weatherProv.hourlyWeather);
